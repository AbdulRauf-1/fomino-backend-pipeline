module.exports = (sequelize, DataTypes) =>{
    ...
    restaurant.associate = (models)=>{
        ...
        restaurant.hasMany(models.invitation);
        models.invitation.belongsTo(restaurant); 
        ...
        // models.cuisine.belongsTo(restaurant); 
        ...
        restaurant.hasOne(models.configuration);
        models.configuration.belongsTo(restaurant); 
        
        
        restaurant.hasMany(models.cusineRestaurant);
        models.cusineRestaurant.belongsTo(restaurant); 
        
        restaurant.hasOne(models.director);
        models.director.belongsTo(restaurant); 
        
        restaurant.hasMany(models.restaurantPayout);
        models.restaurantPayout.belongsTo(restaurant); 
        
        restaurant.hasMany(models.driverCommission);
        models.driverCommission.belongsTo(restaurant); 
        
        restaurant.hasMany(models.driverPayout);
        models.driverPayout.belongsTo(restaurant); 
        
        restaurant.hasMany(models.restaurantOffers);
        models.restaurantOffers.belongsTo(restaurant); 
        
        restaurant.hasMany(models.driverRestaurantHours);
        models.driverRestaurantHours.belongsTo(restaurant); 
        
        restaurant.hasOne(models.menuCategoryLanguage);
        models.menuCategoryLanguage.belongsTo(restaurant); 
        
        restaurant.hasOne(models.stampCardRestaurants);
        models.stampCardRestaurants.belongsTo(restaurant); 
        
        restaurant.hasMany(models.stampCardOrders);
        models.stampCardOrders.belongsTo(restaurant); 
        
        restaurant.hasMany(models.stampCardPoints);
        models.stampCardPoints.belongsTo(restaurant); 
        
        restaurant.hasMany(models.restaurantBanners);
        models.restaurantBanners.belongsTo(restaurant); 
