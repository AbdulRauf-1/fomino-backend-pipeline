module.exports = (sequelize, DataTypes) =>{
    const user = sequelize.define('user', {
        ...
        lastOffline: { type: DataTypes.DATE },
    ...
    user.associate = (models)=>{
        ...
        models.invitation.belongsTo(user);
        user.hasMany(models.driverPayout);
        models.driverPayout.belongsTo(user);
       
        user.hasMany(models.driverOnlineSession);
        models.driverOnlineSession.belongsTo(user);
        ...
        user.hasMany(models.restaurantDriver);
        ...
        user.hasMany(models.driverCommission);
        models.driverCommission.belongsTo(user);
        
        user.hasMany(models.vehicleImages);
        models.vehicleImages.belongsTo(user);
        
        user.hasMany(models.driverRestaurantHours);
        models.driverRestaurantHours.belongsTo(user);
        
        user.hasOne(models.driverHourlyEarnings);
        models.driverHourlyEarnings.belongsTo(user);
        
        user.hasMany(models.stampCardOrders);
        models.stampCardOrders.belongsTo(user);
        
        user.hasMany(models.stampCardPoints);
        models.stampCardPoints.belongsTo(user);
