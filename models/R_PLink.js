module.exports = (sequelize, DataTypes) =>{
    ...
    R_PLink.associate = (models)=>{
        ...
        R_PLink.hasMany(models.productAddons);
        models.productAddons.belongsTo(R_PLink);
        
        R_PLink.hasMany(models.discountProducts);
        models.discountProducts.belongsTo(R_PLink);
        
        R_PLink.hasMany(models.excludeProducts);
        models.excludeProducts.belongsTo(R_PLink);
        
        R_PLink.hasMany(models.freeDeliveryProducts);
        models.freeDeliveryProducts.belongsTo(R_PLink);
