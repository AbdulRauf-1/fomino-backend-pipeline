...
router.post('/addDirector', asyncMiddleware(restController.addDirector));
router.get('/getDirector/:restaurantId', asyncMiddleware(restController.getDirector));
router.post('/updateDirector', asyncMiddleware(restController.updateDirector));
...
router.get('/getConfiguration/:restaurantId', asyncMiddleware(restController.getConfiguration));
router.post('/changeConfiguration', asyncMiddleware(restController.changeConfiguration));
...
// Product Module
router.post('/addProduct', productUpload.fields([{ name: 'image', maxCount: 1 }, { name: 'bannerImage', maxCount: 1 }]), asyncMiddleware(restController.addProduct));
router.post('/editProduct', productUpload.fields([{ name: 'image', maxCount: 1 }, { name: 'bannerImage', maxCount: 1 }]),asyncMiddleware(restController.editProduct));
router.get('/getProducts/:restaurantId', asyncMiddleware(restController.getProducts));
router.post('/getProductById', asyncMiddleware(restController.getProductByIdApi));

router.post('/changeProductStatus',validateToken,asyncMiddleware(restController.changeProductStatus));
...
router.get('/restaurantCusines/:restaurantId', asyncMiddleware(restController.restaurantCusines));
router.post('/assignCuisine', asyncMiddleware(restController.assignCuisine));
router.post('/removeCuisine', asyncMiddleware(restController.removeCuisine));
router.get('/allCuisines/:restaurantId', asyncMiddleware(restController.allCuisines));
...
router.post('/send_invitation', asyncMiddleware(restController.send_invitation));
router.get('/get_invitations/:restaurantId', asyncMiddleware(restController.get_invitations));
router.get('/getRestaurantDetails/:restaurantId', asyncMiddleware(restController.getRestaurantDetails));
router.get('/orderArcheive/:restaurantId', asyncMiddleware(restController.orderArcheive));
router.get('/getRestaurantArea/:restaurantId', asyncMiddleware(restController.getRestaurantArea));
router.post('/addRestaurantDeliveryArea', asyncMiddleware(restController.addRestaurantDeliveryArea));
router.post('/sendInvitationToDriver', asyncMiddleware(restController.sendInvitationToDriver));
router.get('/getPayouts/:restaurantId', asyncMiddleware(restController.getPayouts));
router.get('/pendingPayouts/:restaurantId', asyncMiddleware(restController.pendingPayouts));
router.get('/failedPayouts/:restaurantId', asyncMiddleware(restController.failedPayouts));
router.post('/addPayout', asyncMiddleware(restController.addPayout));
router.post('/acceptDriverPayout', asyncMiddleware(restController.acceptDriverPayout));
router.post('/blockDriver', asyncMiddleware(restController.blockDriver));
router.post('/activateDriver', asyncMiddleware(restController.activateDriver));
router.post('/addPromotion', asyncMiddleware(restController.addPromotion));
router.post('/addLanguage', asyncMiddleware(restController.addLanguage));
router.post('/rejectPayout', asyncMiddleware(restController.rejectPayout));
router.get('/driversPayouts/:restaurantId', asyncMiddleware(restController.driversPayouts));
router.post('/changeLanguage', asyncMiddleware(restController.changeLanguage));
router.get('/getAllBanners/:restaurantId', asyncMiddleware(restController.getAllBanners));
router.post('/addBanner',upload.single("image"), asyncMiddleware(restController.addBanner));
router.post('/updateBanner',upload.single("image"), asyncMiddleware(restController.updateBanner));
router.post('/deleteBanner', asyncMiddleware(restController.deleteBanner));
router.post('/changeStatusBanner', asyncMiddleware(restController.changeStatusBanner));
router.get('/getBanners/:id', asyncMiddleware(restController.getBanners));
router.get('/getAdultsProducts/:restid', asyncMiddleware(restController.getAdultsProducts));
