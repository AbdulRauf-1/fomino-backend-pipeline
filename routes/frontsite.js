...
router.post('/verifyOTP', asyncMiddleware(frontsiteController.verifyOTP));
//4. Sign in the user
...
router.get('/userFavRestaurantIds/:userId', asyncMiddleware(frontsiteController.userFavRestaurantIds));
router.post('/removeFromFav', asyncMiddleware(frontsiteController.removeFromFav));
router.post('/removeFromWishList', asyncMiddleware(frontsiteController.removeFromWishList));
